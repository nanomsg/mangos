...
image:https://img.shields.io/discord/639573728212156478?label=discord[Discord,link="https://discord.gg/wewTkby"]
image:https://img.shields.io/codecov/c/github/nanomsg/mangos[Coverage,link="https://codecov.io/gh/nanomsg/mangos"]
